...
export const metadata = {
  title: "DB Viewer",
  description: "View all database tables and their rows.",
};
...
export default async function DatabaseViewerPage() {
  ...
  return (
    <div className="p-6 space-y-10 mx-auto max-w-5xl w-full">
      ...
      {Object.keys(data).length === 0 ? (
        ...
        Object.entries(data).map(([tableName, rows]) => (
          <div
            key={tableName}
            className="border mb-4 rounded-lg shadow-sm bg-white dark:bg-slate-800"
          >
